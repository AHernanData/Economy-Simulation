...
class company:
    ...
    def __init__(self,citizen,startup,product,cost=3):
        ...
        self.product_alignment(product)
        if product == 1:
    ...
    def product_alignment(self,product):
        exec('self.__class__ = %s' % (company.company_product[product-1]),globals(),locals())
    ...
    def month_end(self):
        ...
        employee_income = round(0.8*self.labor/(1+len(self.employees)),2)
        owner_income = round(owner_bonus + employee_income,2)
...
class food_c(company):
    ...
    food_costs = [[],[],[],[],[]]
    food_quality = [[],[],[],[],[]]
    alignment = [food_costs, food_quality]
...
class manufacturing_c(company):
    ...
    alignment = [manufacturing_costs, manufacturing_quality]
