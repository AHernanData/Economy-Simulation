...
class company:
    ...
    def month_end(self):
        ...
        self.funds -= employee_income*len(self.employees) + owner_income
        self.recent_funds = self.funds
        self.positions_available = int(self.worth/100)
        self.log.append(['Income was ${}, paid owner ${}, paid employees ${}, funds are now ${}, worth is ${}'.format(self.income,owner_income,employee_income,self.funds,self.worth)])
